    ...
    <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white'>
        ...
        <h1 className='text-[#00df9a] w-full text-3xl font-bold m-4'>REACT.</h1>
            <ul className='p-4 uppercase cursor-pointer'>
                <li className='p-4 border-b border-b-gray-600 hover:scale-110 hover:text-[#00df9a]'>Home</li>
                <li className='p-4 border-b border-b-gray-600 hover:scale-110 hover:text-[#00df9a]'>Company</li>
                <li className='p-4 border-b border-b-gray-600 hover:scale-110 hover:text-[#00df9a]'>Resources</li>
                <li className='p-4 border-b border-b-gray-600 hover:scale-110 hover:text-[#00df9a]'>About</li>
                <li className='p-4 hover:scale-110 hover:text-[#00df9a]'>Contact</li>
            </ul>
        </div>
